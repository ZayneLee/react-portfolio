                ...
                <Card sx={{ maxWidth: 345 }}>
                  ...
                  <CardContent>
                    ...
                    <Typography variant="body2" color="text.secondary">
                      ...
                      that adds optional type annotations to the language. It
                      provides better code maintainability, readability, and
                      tooling support, making it easier to catch errors early in
                      the development process. TypeScript is often used with
              ...
              <Grid item xs={12} sm={6} md={4}>
                <Card sx={{ maxWidth: 345 }}>
                  ...
                  <CardContent>
                    ...
                    <Typography variant="body2" color="text.secondary">
                      The Spring Framework is a powerful Java-based framework
                      for building enterprise applications. It simplifies the
                      development process by providing a comprehensive
                      programming and configuration model, addressing various
                      infrastructure concerns like database access, security,
                      and transaction management. Spring Boot, a sub-project of
                      Spring, makes it even easier to create stand-alone,
                      production-ready Spring applications with minimal
                      configuration.
                    </Typography>
                  </CardContent>
                </Card>
                ...
                <Card sx={{ maxWidth: 345 }}>
                  ...
                  <CardContent>
                    ...
                    <Typography variant="body2" color="text.secondary">
                      ...
                      collaborate with others. It stores the history of changes
                      in a central repository, and developers can commit their
